...
void SetComfyTheme()
{
	// Comfy (better for android) style from ImThemes
	ImGuiStyle& style = ImGui::GetStyle();
	...
	style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.2588235437870026f, 0.2588235437870026f, 0.2588235437870026f, 0.4862745106220245f);
	...
	style.Colors[ImGuiCol_CheckMark] = ImVec4(0.6961215734481812f, 0.5475510954856873f, 0.7639485001564026f, 1.0f);
